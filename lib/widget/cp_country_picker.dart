...
class CPCountryPicker extends StatefulWidget {
  CPCountryPicker(
...
class _CountryPickerState extends State<CPCountryPicker> {
  ...
  void didChangeDependencies() async {
    if (widget.isInit) {
      ...
      final data = await DefaultAssetBundle.of(context)
          .loadString('assets/json_data/countrycodes.json');
      setState(() {
      ...
      child: InkResponse(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            border: Border(
              bottom: BorderSide(width: 1.0, color: widget.underLineColor),
            ),
            //color: Colors.red,
          ),
          child: Row(
            ...
            children: [
              ...
              Text(
                selectedCountryData != null ? selectedCountryData.code : '',
